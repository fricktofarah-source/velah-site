          ...
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            ...
            <div className="p-8 sm:p-10 lg:p-14 flex flex-col gap-6">
              ...
              <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-slate-900">
                Glass that feels at home on your counter.
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                Velah bottles hold a balanced mineral profile, stay neutral in flavour, and arrive chilled.
                Stainless caps seal tight so you can move from breakfast to evening gatherings without
                worrying about plastic taste or condensation rings.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Link href="/about" className="link-underline text-sm font-medium text-slate-700">
                  How Velah prepares every bottle
                </Link>
              </div>
            </div>
          </div>
