...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      {/* RIBBON — full-bleed nature strip for mood */}
      <Section bleed>
        <div className="relative h-[38vh] min-h-[260px] w-full overflow-hidden">
          <Image
            src="/assets/glass-in-stream.jpg" /* add image */
            alt="Velah glass in nature"
            fill
            className="object-cover"
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-white/70 via-white/20 to-white/70" />
        </div>
      </Section>
